...
try {
  ...
  const report = {
    schemaVersion: "orch-auth-01-c3-oci-audit.v1",
    status: "PASS",
    claim:
      "disposable Ubuntu guest OCI runtime qualification with inspectable fixture evidence",
  ...
  await writeReceipt(context, checks, [
    { path: "runtime-audit.json", kind: "orch-auth-c3-oci-audit" },
  ]);
